...
**Smart skill index compaction for Hermes Agent — progressive disclosure with budget control and usage-frequency learning.**
...
git clone https://github.com/<you>/progressive-skill ~/.hermes/plugins/progressive-skill
...
Requires Hermes desktop app or CLI (any version with `agent.prompt_builder.build_skills_system_prompt` and the `compact_categories` kwarg).
